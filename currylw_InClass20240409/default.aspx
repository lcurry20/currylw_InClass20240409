<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="currylw_InClass20240409._default" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ListBox OnSelectedIndexChanged="lbFruits_SelectedIndexChanged" ID="lbFruits" runat="server" CssClass="ListBoxCssClass" Height="133px" AutoPostBack="True" DataSourceID="SqlDataSourceInClass20240409" DataTextField="LastName" DataValueField="NameID">
